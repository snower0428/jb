...
@class NSData, NSMutableArray, NSMutableData, YMLGCDAsyncReadPacket, YMLGCDAsyncWritePacket;

__attribute__((visibility("hidden")))
@interface YMLGCDAsyncSocket : NSObject
{
    unsigned int flags;
    ...
    YMLGCDAsyncReadPacket *currentRead;
    YMLGCDAsyncWritePacket *currentWrite;
