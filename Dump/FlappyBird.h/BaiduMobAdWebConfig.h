...
@property(nonatomic) BOOL hasCloseControl; // @synthesize hasCloseControl=_hasCloseControl;
@property(nonatomic) BOOL hasVolumeControl; // @synthesize hasVolumeControl=_hasVolumeControl;
@property(nonatomic) int clickBtnDelay; // @synthesize clickBtnDelay=_clickBtnDelay;
- (void)setWebConfigForWeb:(id)arg1;
- (id)init;
