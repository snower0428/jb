...
@class IGAnalyticsManager, IGFeedItemTrackingManager, IGLocalNotificationManager, IGLoggedOutSessionManager, IGMediaManager, IGNavigationEventManager, IGSurveyManager, IGTypicalMetricsManager, IGUserTrackingManager;
...
@property(retain, nonatomic) IGUserTrackingManager *userTrackingManager; // @synthesize userTrackingManager=_userTrackingManager;
