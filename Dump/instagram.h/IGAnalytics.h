...
@class IGAnalyticsConnectionObserver, IGAnalyticsLogger, IGAnalyticsSession, IGAnalyticsUploader, IGImmediateActiveSeconds, NSObject<OS_dispatch_queue>, NSString, NSTimer;
...
- (void)uploadEvents;
- (void)uploadLowLatencyEvents:(id)arg1 allowableRetries:(int)arg2;
