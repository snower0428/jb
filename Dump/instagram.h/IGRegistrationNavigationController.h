...
#import "IGRegistrationDiscoverMorePeopleDelegate.h"
...
@class IGRegistrationDiscoverMorePeopleViewController, NSDictionary, NSString;

@interface IGRegistrationNavigationController : IGNavigationController <IGUsernameViewControllerDelegate, IGNavigationControllerDelegate, IGRegistrationFindUsersViewControllerDelegate, IGRegistrationDiscoverMorePeopleDelegate, IGWelcomeViewControllerDelegate>
{
    int _currentStep;
    ...
    IGRegistrationDiscoverMorePeopleViewController *_discoverMorePeopleVC;
}

@property(retain, nonatomic) IGRegistrationDiscoverMorePeopleViewController *discoverMorePeopleVC; // @synthesize discoverMorePeopleVC=_discoverMorePeopleVC;
...
- (void).cxx_destruct;
- (void)registrationDiscoverMorePeopleControllerDidContinue:(id)arg1;
