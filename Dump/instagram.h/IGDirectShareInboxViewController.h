...
- (void)postViewControllerDidDetectCorruptPost:(id)arg1;
- (void)postViewControllerDidIgnoreSender:(id)arg1;
- (void)postViewControllerDidReportInAppropriate:(id)arg1;
- (void)postViewControllerDidTapClose:(id)arg1;
- (void)postViewControllerDidTapHide:(id)arg1;
- (void)postViewControllerDidTapDelete:(id)arg1;
...
- (void)ignoreSender:(id)arg1;
- (void)hidePost:(id)arg1;
- (void)deletePost:(id)arg1;
- (void)pushToPostWithPrimaryKey:(id)arg1 viaPush:(BOOL)arg2 animated:(BOOL)arg3;
- (void)reloadAllData;
- (void)reloadUploads;
- (void)performHideAndIgnoreSenderForPost:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)performHideForPost:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)performDeleteForPost:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)removeNux;
- (void)showNux;
