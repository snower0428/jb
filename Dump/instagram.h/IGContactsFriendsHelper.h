...
@class NSString, UIViewController<IGContactsFriendsHelperDelegate>;

@interface IGContactsFriendsHelper : NSObject <IGContactsHelperDelegate, UIAlertViewDelegate, IGFindFriendsHelperProtocol>
{
    UIViewController<IGContactsFriendsHelperDelegate> *_delegate;
}

@property(nonatomic) __weak UIViewController<IGContactsFriendsHelperDelegate> *delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
