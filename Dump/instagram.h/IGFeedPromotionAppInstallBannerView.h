...
@class IGFeedPromotionBannerConfiguration, IGSimpleButton, UIButton, UIImageView, UILabel;
...
@property(retain, nonatomic) IGSimpleButton *installButton; // @synthesize installButton=_installButton;
