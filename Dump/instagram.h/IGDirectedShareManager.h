...
@class IGKVOHandle, IGMediaMetadata, IGSectionIndexView, IGTokenField, IGUserListLocalDataSource, IGUserListNetworkDataSource, NSArray, NSCountedSet, NSObject<IGSearchDataSource>, NSString, UIScrollView, UIView, UIViewController<IGShareManagerDelegate>;
...
@interface IGDirectedShareManager : IGGroupedTableViewController <UITableViewDataSource, UITableViewDelegate, IGUserListNetworkDataSourceDelegate, IGSectionIndexViewDelegate, IGTokenFieldDelegate, IGShareManager>
{
    ...
    NSObject<IGSearchDataSource> *_currentDataSource;
    UIView *_headerView;
...
@property(nonatomic) NSObject<IGSearchDataSource> *currentDataSource; // @synthesize currentDataSource=_currentDataSource;
