...
@class IGAutocompleteController, IGCaptionCell, IGFeedItem, IGShareListManager, NSString, UIImageView;

@interface IGLegacyShareLaterViewController : IGCollectionViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, IGAutocompleteControllerDelegate, IGCaptionCellDelegate, IGShareListManagerDelegate, MFMailComposeViewControllerDelegate>
{
