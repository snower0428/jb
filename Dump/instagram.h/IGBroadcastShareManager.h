...
@class IGCollectionView, IGMediaMetadata, IGShareListDataSource, IGSwitch, NSString, UIButton, UIScrollView, UIViewController<IGShareManagerDelegate>;

@interface IGBroadcastShareManager : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, IGUserInTaggingViewControllerDelegate, IGLocationPickerDelegate, IGShareListManagerDelegate, IGShareManager>
{
