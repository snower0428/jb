...
@interface LegacySystemAppDelegate : XXUnknownSuperclass <DTMicroApplicationDelegate> {
@private
	UIViewController* _rootController;
}
@property(retain, nonatomic) UIViewController* rootController;
-(void)exitCurrentAppAndStartCurrentApp:(id)app;
...
-(void)handleSpecialService:(id)service;
