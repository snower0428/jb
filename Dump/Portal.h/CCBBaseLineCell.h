...
@class NSDictionary, UIActivityIndicatorView, CCBStyledTableViewCellBackgroundView, UIImageView, NSIndexPath, UILabel, UIButton;

@interface CCBBaseLineCell : XXUnknownSuperclass {
@private
	BOOL separatorLine;
	BOOL hideUnderLine;
	...
	NSDictionary* data;
	CCBStyledTableViewCellBackgroundView* styleBackgroundView;
	UILabel* ivLabel;
...
@property(retain, nonatomic) CCBStyledTableViewCellBackgroundView* styleBackgroundView;
