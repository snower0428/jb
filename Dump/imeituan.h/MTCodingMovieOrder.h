...
@class MTCodingCinema, MTCodingMovieShow, NSArray, NSDate, NSString;

@interface MTCodingMovieOrder : MTCodingObject <MTMovieOrder>
{
    BOOL _embedded;
    BOOL _canUseVoucher;
    int _orderID;
    ...
    MTCodingCinema *_cinema;
    MTCodingMovieShow *_show;
...
@property(retain, nonatomic) MTCodingMovieShow *show; // @synthesize show=_show;
@property(retain, nonatomic) MTCodingCinema *cinema; // @synthesize cinema=_cinema;
