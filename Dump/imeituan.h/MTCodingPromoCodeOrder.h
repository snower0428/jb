...
#import "MTPromoCodeOrder.h"

@class NSArray, NSDate, NSString;

@interface MTCodingPromoCodeOrder : MTCodingOrder <MTPromoCodeOrder>
{
    NSArray *_promoCodeArray;
    NSArray *_refundDetails;
}

@property(retain, nonatomic) NSArray *refundDetails; // @synthesize refundDetails=_refundDetails;
@property(retain, nonatomic) NSArray *promoCodeArray; // @synthesize promoCodeArray=_promoCodeArray;
- (void).cxx_destruct;
