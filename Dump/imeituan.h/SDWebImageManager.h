...
- (id)forceDownloadWithURL:(id)arg1 options:(int)arg2 progress:(CDUnknownBlockType)arg3 completed:(CDUnknownBlockType)arg4;
- (id)cachedImageWithURL:(id)arg1;
- (void)clearImageCacheWithURL:(id)arg1;
