...
@property(readonly, nonatomic) NSString *applicationShortVersion; // @synthesize applicationShortVersion=_applicationShortVersion;
...
- (void)dealloc;
- (id)initWithApplicationIdentifier:(id)arg1 applicationVersion:(id)arg2 applicationShortVersion:(id)arg3;
