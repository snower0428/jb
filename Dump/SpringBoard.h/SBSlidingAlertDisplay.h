...
- (void)setShowingDeviceLock:(BOOL)arg1 duration:(float)arg2 completion:(CDUnknownBlockType)arg3 outDuration:(float *)arg4;
- (void)setShowingDeviceLock:(BOOL)arg1 duration:(float)arg2 completion:(CDUnknownBlockType)arg3;
- (id)deviceLockView;
