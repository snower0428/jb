...
- (void)icon:(SBIconView *)arg1 touchMovedWithEvent:(UIEvent *)arg2;
- (void)iconTouchBegan:(SBIconView *)arg1;
- (void)iconHandleLongPress:(SBIconView *)arg1;
- (BOOL)iconPositionIsEditable:(SBIconView *)arg1;
