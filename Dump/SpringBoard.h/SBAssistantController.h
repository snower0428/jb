...
- (void)uiPluginWantsSizeUpdate:(id)arg1 revealMode:(int)arg2 withBlock:(CDUnknownBlockType)arg3;
- (BOOL)uiPluginWantsActivation:(id)arg1 forEvent:(int)arg2 revealMode:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_presentPopover:(id)arg1 revealMode:(int)arg2 completion:(CDUnknownBlockType)arg3;
