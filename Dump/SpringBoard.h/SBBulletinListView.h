...
+ (id)linen;
+ (void)load;
- (void)presentWeeApp:(id)arg1 animateWithDuration:(float)arg2 delay:(float)arg3 completion:(CDUnknownBlockType)arg4;
- (id)presentingWeeApp;
- (void)_removePresentingWeeAppWithDuration:(float)arg1 delay:(float)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_presentWeeApp:(id)arg1 duration:(float)arg2 delay:(float)arg3 completion:(CDUnknownBlockType)arg4;
