...
- (void)showcase:(id)arg1 updateRevealMode:(int)arg2 withBlock:(CDUnknownBlockType)arg3;
- (BOOL)presentShowcaseViewController:(id)arg1 revealMode:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)openNewsstand;
- (void)_dismissShowcase:(double)arg1 unhost:(BOOL)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)_dismissShowcase:(double)arg1 unhost:(BOOL)arg2;
- (void)dismissShowcaseAnimated:(BOOL)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;
- (BOOL)_revealShowcase:(id)arg1 revealMode:(int)arg2 duration:(double)arg3 fromSystemGesture:(BOOL)arg4 revealSetupBlock:(CDUnknownBlockType)arg5;
- (void)_revealShowcaseCore:(id)arg1 revealMode:(int)arg2 duration:(double)arg3 fromSystemGesture:(BOOL)arg4 revealSetupBlock:(CDUnknownBlockType)arg5;
...
- (void)_hideKeyboard;
- (void)setRootViewHiddenForScatter:(BOOL)arg1 duration:(double)arg2 delay:(double)arg3 additionalAnimations:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
- (void)setRootViewHiddenForScatter:(BOOL)arg1 duration:(double)arg2 delay:(double)arg3 completion:(CDUnknownBlockType)arg4;
