...
- (void)setShowsKeyboard:(BOOL)arg1 animated:(BOOL)arg2 shouldDeferResponderStatus:(BOOL)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)setShowsKeyboard:(BOOL)arg1 animated:(BOOL)arg2 shouldDeferResponderStatus:(BOOL)arg3;
- (void)setShowsKeyboardAnimated:(BOOL)arg1 completionBlock:(CDUnknownBlockType)arg2;
