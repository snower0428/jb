...
@class NSArray, NSMutableDictionary, UIImageView, UILabel, UIScreenMode, UITableView, UIView;

__attribute__((visibility("hidden")))
@interface TVOutResListController : UIViewController
{
    ...
    NSArray *availableScreenModes;
}

@property(retain, nonatomic) NSArray *availableScreenModes; // @synthesize availableScreenModes;
@property(retain, nonatomic) UIScreenMode *currentScreenMode; // @synthesize currentScreenMode;
