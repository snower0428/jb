...
@class GCK_GCDAsyncReadPacket, GCK_GCDAsyncSocketPreBuffer, GCK_GCDAsyncWritePacket, NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>;

__attribute__((visibility("hidden")))
@interface GCK_GCDAsyncSocket : NSObject
{
    unsigned int flags;
