...
@interface YePhotoLibraryController : UIViewController <UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate>
{
...
- (void)writefiles;
- (void)viewDidLoad;
- (void)ReloadFileArray:(id)arg1;
- (void)fillFileArray:(id)arg1;
- (void)getCameraRollLibrary;
- (void)show_denied_access_alert;
