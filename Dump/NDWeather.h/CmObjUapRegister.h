...
@class NSString, TAUapRegUser;

@interface CmObjUapRegister : TACommHttp
{
    id bizDelegate;
    TAUapRegUser *regDest;
    NSString *userPwdEncoded;
}
...
@property(copy, nonatomic) NSString *userPwdEncoded; // @synthesize userPwdEncoded;
