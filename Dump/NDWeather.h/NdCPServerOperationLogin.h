...
@interface NdCPServerOperationLogin : NdCPServerOperation
{
    BOOL _rememberPassword;
    BOOL _autoLogin;
    NSString *userName;
    NSString *password;
    BOOL useAutoLoginSign;
    BOOL isDebugMode;
    NSString *uin;
    NSString *nickName;
...
@property(nonatomic) BOOL isDebugMode; // @synthesize isDebugMode;
...
@property(nonatomic) BOOL useAutoLoginSign; // @synthesize useAutoLoginSign;
