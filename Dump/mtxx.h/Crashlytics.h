...
@class CLSAppIconController, CLSClient, CLSSDKController, NSObject<CrashlyticsDelegate>, NSObject<CrashlyticsPlatformDelegate>, NSString, NSTimer;
...
- (void)setupCrashHandling:(id)arg1 environment:(const CDStruct_9c005df8 *)arg2;
