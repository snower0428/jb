...
@class DMDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL;

@interface DMHTTPRequest : NSOperation <NSCopying>
{
    NSURL *url;
    NSURL *originalURL;
    NSURL *redirectURL;
    id <DMHTTPRequestDelegate> delegate;
    id <DMHTTPRequestDelegate><DMProgressDelegate> queue;
    ...
    id <DMProgressDelegate> uploadProgressDelegate;
    id <DMProgressDelegate> downloadProgressDelegate;
    ...
    NSTimer *statusTimer;
    id <DMCacheDelegate> downloadCache;
    int cachePolicy;
...
@property(retain, nonatomic) DMHTTPRequest *PACFileRequest; // @synthesize PACFileRequest;
...
@property(retain) DMDataDecompressor *dataDecompressor; // @synthesize dataDecompressor;
...
@property id <DMCacheDelegate> downloadCache; // @synthesize downloadCache;
...
@property DMHTTPRequest *mainRequest; // @synthesize mainRequest;
