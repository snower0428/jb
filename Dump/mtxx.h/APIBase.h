...
+ (int)getApiBaseSeq;
@property(nonatomic) BOOL allowProgress; // @synthesize allowProgress=_allowProgress;
...
- (void)request:(id)arg1 didSendBodyData:(int)arg2 totalBytesWritten:(int)arg3 totalBytesExpectedToWrite:(int)arg4;
- (void)dealloc;
- (void)cancel;
