...
- (void)performDialogAppCall:(id)arg1 version:(id)arg2 session:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)dispatchDialogAppCall:(id)arg1 version:(id)arg2 session:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)dealloc;
- (id)init;
