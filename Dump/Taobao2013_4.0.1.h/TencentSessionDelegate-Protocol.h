...
@class APIResponse, NSArray, TencentOAuth, UIViewController;
...
- (void)tencentOAuth:(TencentOAuth *)arg1 didSendBodyData:(int)arg2 totalBytesWritten:(int)arg3 totalBytesExpectedToWrite:(int)arg4 userData:(id)arg5;
...
- (BOOL)tencentNeedPerformReAuth:(TencentOAuth *)arg1;
- (BOOL)tencentNeedPerformIncrAuth:(TencentOAuth *)arg1 withPermissions:(NSArray *)arg2;
