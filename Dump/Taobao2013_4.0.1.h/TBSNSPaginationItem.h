...
@interface TBSNSPaginationItem : NSObject
{
    ...
    BOOL _useTimesatmpAsReference;
    int _direction;
    int _paginationType;
    int _paginationTimestamp;
}

@property(nonatomic) BOOL useTimesatmpAsReference; // @synthesize useTimesatmpAsReference=_useTimesatmpAsReference;
...
@property(nonatomic) BOOL isTimestampEnable; // @synthesize isTimestampEnable=_isTimestampEnable;
