...
@class NSMutableData, SPDYFrameDecoder, SPDYFrameEncoder, SPDYOrigin, SPDYSocket, SPDYStreamManager;
...
- (id)initWithOrigin:(id)arg1 configuration:(id)arg2 error:(id *)arg3;
