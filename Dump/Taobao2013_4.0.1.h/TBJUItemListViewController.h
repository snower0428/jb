...
@class BannerApiContext, NSArray, NSDictionary, NSMutableArray, NSString, TBBarButtonItem, TBExpandOrContractScrollViewDelegateObject, TBJUBannerView, TBJUBrandHeader, TBJUMainListLoadMoreCell, TBJUMainListViewController, TBJUTopBannerView, TBMTOPRequest, TBModelStatusHandler, TBTOPRequest, UIControl, UIImageView, UILabel, UITableView, UIView;

@interface TBJUItemListViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, TBExpandOrContractScrollViewDelegate, TBJUBannerViewDelegate, TBJUTopBannerViewDelegate>
{
    int _pageSize;
    int _pageToFetch;
    int _zeroItemsCount;
...
@property(nonatomic) BOOL layoutItemSelected; // @synthesize layoutItemSelected=_layoutItemSelected;
...
- (void).cxx_destruct;
- (void)sendJubaopenNativeListRequest;
