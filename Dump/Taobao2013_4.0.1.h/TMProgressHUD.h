...
@interface TMProgressHUD : UIView
{
    ...
    float progress;
    id <TMProgressHUDDelegate> delegate;
    NSString *labelText;
...
@property BOOL diTMackground; // @synthesize diTMackground;
@property float margin; // @synthesize margin;
@property(nonatomic, getter=isShowing) BOOL showing; // @synthesize showing;
...
@property id <TMProgressHUDDelegate> delegate; // @synthesize delegate;
