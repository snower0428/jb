...
@class NSData, NSInputStream, NSMutableData, NSRunLoop, NSString, NSURLRequest, SPDYProtocol;
...
@property(retain, nonatomic) NSMutableData *multiData; // @synthesize multiData=_multiData;
