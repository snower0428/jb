...
@interface TBDataFMDatabase : NSObject
{
    struct sqlite3 *db;
...
- (BOOL)executeUpdate:(id)arg1 error:(id *)arg2 withArgumentsInArray:(id)arg3 orVAList:(void *)arg4;
...
- (void)_extractSQL:(id)arg1 argumentsList:(void *)arg2 intoString:(id)arg3 arguments:(id)arg4;
