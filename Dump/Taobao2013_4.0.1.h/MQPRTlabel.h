...
@interface MQPRTlabel : UIView
{
    ...
    id <MQPRTLabelDelegate> _delegate;
...
@property(nonatomic) BOOL hasStrikethrough; // @synthesize hasStrikethrough=_hasStrikethrough;
...
@property(nonatomic) id <MQPRTLabelDelegate> delegate; // @synthesize delegate=_delegate;
...
- (id)replacebreakLineSymbolWithText:(id)arg1;
- (id)visibleText;
...
- (int)fontSizeWithHtmlFontSize:(id)arg1;
