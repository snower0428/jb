...
@interface TBJUTodayViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, TBExpandOrContractScrollViewDelegate, TBJUBannerViewDelegate, TBJUTopBannerViewDelegate>
{
    int _pageSize;
    int _pageToFetch;
    int _zeroItemsCount;
