...
@interface TBMMBProgressHUD : UIView
{
    BOOL useAnimation;
    ...
    int animationType;
    id <TBMMBProgressHUDDelegate> delegate;
    float opacity;
    UIColor *color;
    UIFont *labelFont;
...
@property id <TBMMBProgressHUDDelegate> delegate; // @synthesize delegate;
@property int animationType; // @synthesize animationType;
- (void)setTransformForCurrentOrientationWithoutSuperViewSync:(BOOL)arg1;
