...
@class NSMutableDictionary, NSString, TBDataFMDatabase, TBDataFMStatement;

@interface TBDataFMResultSet : NSObject
{
    TBDataFMDatabase *parentDB;
    TBDataFMStatement *statement;
    NSString *query;
...
@property(retain) TBDataFMStatement *statement; // @synthesize statement;
