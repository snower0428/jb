...
+ (id)SDKInfo;
+ (BOOL)isRegistSchemeInfoPlistFile:(id)arg1;
+ (id)getAppDefinePath;
...
+ (void)MoveAllWindowIntoScreen:(id)arg1 animation:(BOOL)arg2;
+ (void)MoveAllWindowOutOfScreen:(id)arg1 animation:(BOOL)arg2;
