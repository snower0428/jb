...
- (id)dataFromKey:(id)arg1 fromDisk:(BOOL)arg2;
- (id)dataFromKey:(id)arg1;
- (void)storeData:(id)arg1 forKey:(id)arg2 toDisk:(BOOL)arg3;
- (void)storeData:(id)arg1 forKey:(id)arg2;
- (void)storeImage:(id)arg1 forKey:(id)arg2 toDisk:(BOOL)arg3 withRepresentation:(_Bool)arg4;
