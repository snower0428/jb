...
@class ASIDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL, TBNetworkUserTrack;
...
@interface ASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    BOOL _haveReceiveResponse;
    BOOL _haveReceiveFirstData;
    BOOL _haveResponseFinish;
    TBNetworkUserTrack *_networkUserTrack;
    NSDate *_requestBeginDate;
    NSDate *_hostResolveBeginDate;
    NSDate *_connetionBeginDate;
    NSDate *_streamOpenDate;
    NSDate *_streamAvaibleDate;
    NSDate *_streamFinishedDate;
    NSDate *_downLoadDataBeginDate;
    NSDate *_downLoadDataEndDate;
}
...
+ (int)streamEndReferCount;
+ (void)decreaseStreamByteAvailableReferCount;
+ (void)increaseStreamByteAvailableReferCount;
+ (int)streamByteAvailableReferCount;
+ (void)decreaseStreamOpenReferCount;
+ (void)increaseStreamOpenReferCount;
+ (int)streamOpenReferCount;
@property(nonatomic) BOOL haveResponseFinish; // @synthesize haveResponseFinish=_haveResponseFinish;
@property(nonatomic) BOOL haveReceiveFirstData; // @synthesize haveReceiveFirstData=_haveReceiveFirstData;
@property(nonatomic) BOOL haveReceiveResponse; // @synthesize haveReceiveResponse=_haveReceiveResponse;
...
@property(retain, nonatomic) TBNetworkUserTrack *networkUserTrack; // @synthesize networkUserTrack=_networkUserTrack;
